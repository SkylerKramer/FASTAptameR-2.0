...
ui <- navbarPage("FASTAptameR 2.0",
                 ...
                 tabPanel("Count",
                          ...
                          sidebarLayout(
                              sidebarPanel(
                                  # ask for input file
                                fileInput("countInput", label = strong("Choose data to count*:"),
                                  ...
                                  textInput("countInput_URL", label = strong("Online source:"),
                                  ...
                                  radioButtons("countDownloadType", label = strong("FASTA or CSV download?"),
                                  ...
                                  sliderInput("countSlider_minReads", label = strong("Min. number of reads to plot:"),
                                  ...
                                  sliderInput("countSlider_maxRanks", label = strong("Max. rank to plot:"),
                                  ...
                                  radioButtons("abundButton", label = strong("Adjust default bins?"),
                                  ...
                                  conditionalPanel(
                                      ...
                                      radioButtons("singletonButton", label = strong("Should singletons be a separate category?"),
                          ...
                          tabsetPanel(
                              ...
                              tabPanel("Diversity",
                                       sidebarLayout(
                                           sidebarPanel(
                                               # ask for input file
                                               fileInput("clusterDiversityInput", label = strong("Input data:"),
                                               ...
                                               radioButtons("kmerPCAButton_k", label = strong("kmer size for PCA plot:"),
